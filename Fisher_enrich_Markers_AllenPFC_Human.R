...
wgcna = list.files(path = "output/",pattern = 'Markers_Significant_DGE_HumanID.txt',full.names = TRUE)
...
load("utils/Allen_MultiReg_CellMarkers_GeneSet.RData")
...
write.table(tmp2,"output/Labels_Clusters.txt",sep="\t",quote=F)
...
pdf("output/Allen_PFC_Enrichment_HumanID.pdf",width=18,height=8)
ggscatter(p, 
        x = "variable",
        y = "Module",
        size="OR",
